...
public class RequestService {
	...
	public Request requestLogoff(Request request) 
	{
		...
		Assert.isNull(this.requestRepository.findPendingRequestByPatientId(request.getPatient().getId(), RequestType.LOGOFF), "This patient already has a pending logoff request");
